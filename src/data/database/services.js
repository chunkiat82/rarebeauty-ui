...
const listOfServices = Object.keys(mapOfServices).map(  
  (key, index) => {
    mapOfServices[key].index = index;
    mapOfServices[key].id = key;
    mapOfServices[key].count = 1;
    return mapOfServices[key]
  }
);

const astListOfServices = new AST(listOfServices).getArray();
// console.log(JSON.stringify(arrays, null, 2));

export { listOfServices, mapOfServices, astListOfServices };
